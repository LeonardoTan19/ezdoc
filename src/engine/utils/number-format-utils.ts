import type { NumberStyle } from '../schema'
...
export function formatByStyle(value: number, style: NumberStyle): string {
  ...
  if (style === 'zhHans') {
    return toChinese(value, ZH_HANS_DIGITS, ZH_HANS_UNITS)
  }

  if (style === 'zhHant') {
    return toChinese(value, ZH_HANT_DIGITS, ZH_HANT_UNITS)
  }
